...
<body>
    <div style='padding:0 8% 0 8%; top:0;left:0;width:100%;overflow:hidden'>
        ...
        <img src='/img/eye.svg' height=12pt /> button, or press 'a' on your keyboard..
        </p>
        ...
        <img src='/img/speaker.svg' width=30pt /> button, or press ';' on your keyboard.
        </p>
        ...
        <p>
        This work is Free/Open Source software. It may be modified and redistributed
        under the terms of the GNU General Public License version 3 or higher. The source
        code and information on contributing to development can be found on the github page,
        <a href='https://github.com/jperryhouts/Dual-N-Back'>
            https://github.com/jperryhouts/Dual-N-Back
        </a>.
        </p>
